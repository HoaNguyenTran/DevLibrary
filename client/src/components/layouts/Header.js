...
import { toggleSidebar } from "../../actions/ui/uiSlice";
import { searchBooks } from "../../actions/books/booksSlice";
import { fetchUser } from "../../actions/user/userSlice";
    ...
    <header id="header">
      <div className="header__wrapper">
        ...
        <div className="header__logo">
          <Link to="/">
            <h1 className="header__logo--content">DevLibrary</h1>
          </Link>
        </div>
