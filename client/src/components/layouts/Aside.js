...
const Aside = () => {
  ...
  const toggle = (e) => {
    ...
    let target = e.currentTarget.childNodes[2];
    let icon = e.currentTarget.childNodes[1];
    subMenu = [...subMenu];
    subMenu.map((menu) => {
      if (target !== menu) {
  ...
  return (
    <aside className={`side-nav${sideBar ? " active" : ""}`}>
      <ul className="side-nav__list">
        ...
        <li
          className="side-nav__list--item business-item"
          onClick={(e) => toggle(e)}
        >
          <div>
          ...
          <div className="sub-menu menu-business">
            <ul>
              ...
              <li>
                <Link
                  to="/books/genre/business-analysis"
        ...
        <li className="side-nav__list--item education-item" onClick={toggle}>
          <div>
        ...
        <li className="side-nav__list--item literary-item" onClick={toggle}>
          <div>
        ...
        <li className="side-nav__list--item young-item" onClick={toggle}>
          <div>
